...
public class ECPoint_Helper {
    ...
    public ECPoint_Helper(ECConfig ecCfg) {
        ...
        ecc.locker.registerLock(uncompressed_point_arr1);
        ...
        ecc.locker.registerLock(hashArray);
    ...
    public void unlockAll() {
        ...
        if (ecc.locker.isLocked(uncompressed_point_arr1)) {
            ecc.locker.unlock(uncompressed_point_arr1);
        }
    }
